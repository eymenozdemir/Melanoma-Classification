...
### 0.8355 score: changed network architecture to vgg16 to provide transfer learning, image sizes are decreased back to (224,224) after poor performance with (512,512)
